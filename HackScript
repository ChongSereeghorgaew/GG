if game:GetService("CoreGui"):FindFirstChild("Paradise Hub [ Blox Fruit ]") then
    game:GetService("CoreGui"):FindFirstChild("Paradise Hub [ Blox Fruit ]"):Destroy()
end
...
function CheckQuest()
   ...
   if Sea2 then
      ...
      elseif MyLevel == 800 or MyLevel <= 874 then -- Factory Staff [Lv. 800]
         ...
         CFrameQuest = CFrame.new(632.698608, 73.1055908, 918.666321, -0.0319722369, 8.96074881e-10, -0.999488771, 1.36326533e-10, 1, 8.92172336e-10, 0.999488771, -1.07732087e-10, -0.0319722369)
         CFrameMon = CFrame.new(530.750916, 123.605103, 368.237427, 0.921237469, 2.73917777e-08, 0.389000654, -3.86523347e-09, 1, -6.12620568e-08, -0.389000654, 5.49333201e-08, 0.921237469)
   ...
   if ThreeWorld then
      ...
      elseif MyLevel == 2200 or MyLevel <= 2224 then
         ...
         CFrameQuest = CFrame.new(-2021.6719970703125, 38.39204406738281, -12029.84765625)
         CFrameMon = CFrame.new(-2286.361328125, 92.34593200683594, -12044.2314453125)
      elseif MyLevel == 2225 or MyLevel <= 2249 then
         ...
         NameMon = "Cake Guard"
         CFrameQuest = CFrame.new(-2021.6719970703125, 38.39204406738281, -12029.84765625)
         CFrameMon = CFrame.new(-1701.4571533203125, 140.1138153076172, -12482.7841796875)
      elseif MyLevel == 2250 or MyLevel <= 2274 then
         Ms = "Baking Staff [Lv. 2250]"
         NaemQuest = "CakeQuest2"
         LevelQuest = 1
         NameMon = "Baking Staff"
         CFrameQuest = CFrame.new(-1927.836669921875, 37.97220230102539, -12841.9560546875)
         CFrameMon = CFrame.new(-1826.8179931640625, 92.20247650146484, -12889.138671875)
      elseif MyLevel >= 2300 then
         ...
         NameMon = "Head Baker"
         CFrameQuest = CFrame.new(-1927.836669921875, 37.97220230102539, -12841.9560546875)
         CFrameMon = CFrame.new(-2309.0947265625, 105.8514404296875, -12933.30078125)
      end
      end
   end
function totween()
...
local venyx = library.new("Paradise Hub [ Blox Fruit ]", 5013109572)
...
local section1 = page:addSection("Script:")
local section1 = page:addSection("Discord/Youtube")
section1:addButton("Copy Discord Server", function()
setclipboard("https://discord.com")
end)
section1:addButton("Copy Youtube", function()
setclipboard("https://www.youtube.com/channel/UCoiO9KywyIDz50PgPfXlcBA")
end)
...
section3:addToggle("Auto Stats Gun",false,function(value)
_G.AutoGun = value
end)
            ...
            for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                    pcall(function()
                        ...
                        until not _G.killaurxaxx  or not v.Parent or v.Humanoid.Health <= 0
                    end)
                end
            end
        end
...
if Sea2 then
   Raid:addToggle(" Auto Next Island [ Raid ]",false,function(value)
    ...
    spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
        if _G.FarmLevel  or _G.NextIsland or _G.EliteHunt or _G.Mastery or _G.MobAura or AutoFarmBoss or Auto_Bone or AutoBartilo or _G.Buddy or AutoRainbow or _G.MasteryGun then
...
_G.ServerHop = true
    if _G.ServerHop == false then return end
    while _G.ServerHop do wait()
        wait(120)
            local PlaceID = game.PlaceId
    local AllIDs = {}
    local foundAnything = ""
